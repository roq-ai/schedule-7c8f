  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="SCHEDULE - Simplifying Room Booking. Choose your room, pick a date, view existing schedules, and make your reservation. A seamless process for your convenience."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1444201983204-c43cbd584d93?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxyb29tJTIwYm9va2luZ3xlbnwwfHx8fDE2OTUyMjY1OTR8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`SCHEDULE - Simplifying Room Booking. Choose your room, pick a date, view existing schedules, and make your reservation. A seamless process for your convenience.`}
            </Text>
            <Box
